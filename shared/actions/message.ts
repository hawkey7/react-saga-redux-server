...
export const getMessagesStatusSucceeded = createAction<MessagesStatus>('message/GET_MESSAGES_STATUS_SUCCEEDED')
...
export const getMessageListSucceeded = createAction<MessagesList>('message/GET_MESSAGE_LIST_SUCCEEDED')
...
export const getMessageDetailSucceeded = createAction<MessagesDetail>('message/GET_MESSAGE_DETAIL_SUCCEEDED')
